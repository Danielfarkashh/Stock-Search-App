...
public class CurrentStockInfo extends Fragment {
    ...
    public static CurrentStockInfo newInstance(String stockName) {
        CurrentStockInfo fragment = new CurrentStockInfo();
