...
public class PairRecyclerView extends RecyclerView.Adapter<PairRecyclerView.ViewHolder> {

    private List<Pair> values;

    // Constructor
    public PairRecyclerView(List<Pair> myDataset) {
        values = myDataset;
    }
    ...
    @Override
    public PairRecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewTop) {
