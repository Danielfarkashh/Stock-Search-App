...
public class HistoricalData extends Fragment {
    ...
    public static HistoricalData newInstance(String stockName, String histDate) {
        HistoricalData fragment = new HistoricalData();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        // Get the view.
        View root = inflater.inflate(R.layout.recycler_view_historical, container, false);
    ...
    private class JsonTask extends AsyncTask<String, Long, Pair[]> {
        ...
        protected void onPostExecute(Pair[] result) {
            ...
            mAdapter = new PairRecyclerView(pairs);
